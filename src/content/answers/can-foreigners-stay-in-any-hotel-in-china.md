...
order: 15
updated: 2026-08-19
keywords: [hotels for foreigners china, hotel refused foreigner china, china hotel licence foreign guests, where can foreigners stay china]
related:
...
Ask the desk to call the local PSB — sometimes the answer is uncertainty rather than a genuine licensing gap, and a phone call resolves it. Otherwise, move on. It is not a judgement about you, and arguing will not change the software they are typing into.

## The chains worth knowing

Visitors default to Marriott and Hilton and pay roughly triple. China's mid-market domestic chains are modern, spotless, reliably licensed and ¥250–450 a night:

- **Atour** — design-led, notably good beds, ¥400–650
- **Ji Hotel** — clean minimalist mid-range, ¥300–480
...
What to expect inside a Chinese hotel room — the deposit, the firm mattress, the heating line that runs across the country — is in our [accommodation guide](/guides/accommodation-in-china/).
