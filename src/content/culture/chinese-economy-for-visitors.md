---
title: The Chinese Economy for Visitors
navTitle: Economy for Visitors
metaTitle: "The Chinese Economy for Visitors: What You're Actually Looking At"
description: Why every Chinese city has a vast new district, what city tiers really mean, why the country is effectively cashless, and who the people working around you are.
standfirst: A fortnight in China leaves most visitors with the same unanswered questions. Why is there an empty new city on the edge of every town? Why does nobody use cash? Why is the train network that big? None of these is mysterious, and the answers explain most of what you are looking at.
eyebrow: Culture
order: 8
updated: 2026-08-19
keywords: [chinese economy for travellers, china ghost cities, china tier 1 tier 2 cities, why is china cashless, hukou system explained, china high speed rail network]
facts:
  - New districts | Built ahead of demand, by design
  - City tiers | Not an official ranking, mostly
  - Cash | Legal tender, and cannot be refused
  - Living away from home | Around 358 million people
  - High-speed rail | Passed 50,000 km in December 2025
related:
...
This page is the companion to [how China actually works](/culture/how-china-works/), which covers the administrative machinery. This one covers the economic landscape — the physical and financial things a visitor sees and cannot immediately explain.
...
:::note "Ghost cities" — the honest version
Foreign coverage has long featured photographs of empty Chinese apartment towers. The photographs are real. The conclusion usually drawn from them is less reliable in both directions.

Some new districts did fill, over five or ten years, and are now ordinary places to live — Zhengzhou's Zhengdong district is the standard example of one that was written off early and then populated. Others have not filled and may not. Property developer distress from the early 2020s left genuinely unfinished projects in many cities, which is a different phenomenon from an empty-but-complete district.

The honest position is that vacancy varies enormously by city and there is no reliable national figure for it. Treat a single photograph — in either direction — as evidence of one place on one day.
:::
...
The practical consequence for a foreign visitor is covered properly in the [money and payments guide](/guides/money-and-payments-in-china/): link an international card inside Alipay or WeChat Pay before you arrive, and you will be able to pay for essentially everything.

:::warn Cash is legal tender and refusing it is illegal
You will occasionally meet a shop or a stall that seems unable to take cash, and it is easy to conclude that cash no longer works. Legally it does. Chinese law provides that renminbi must be accepted for all public and private debts within China, and the central bank has repeatedly said so — most explicitly in its Announcement No. 18 of 2020 — and has fined businesses that refused it.

In practice a small vendor may genuinely have no change, and pushing the point is rarely worth it. But if you are stuck without a working payment app, cash is not merely tolerated: refusing it is a breach of the rules, and saying so politely tends to resolve things.
:::
...
:::warn Do not treat a city's "tier" as an official status
English-language writing frequently describes somewhere as "an official tier-two city", which is not a thing outside the statistics bureau's housing survey. The tiers are a useful shorthand for scale, wealth and consumer market — Chengdu and Hangzhou feel different from Beijing, and different again from a prefecture capital — but nobody is issuing the designation.
:::
...
For what things actually cost, see the [trip cost and budget guide](/plan/china-trip-cost-budget/); for the administrative side of all this, see [how China actually works](/culture/how-china-works/).
