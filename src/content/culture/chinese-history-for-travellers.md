---
title: Chinese History for Travellers
navTitle: History in brief
metaTitle: "Chinese History for Travellers: Dynasties, Dates & What to See"
description: A traveller's guide to Chinese history — the dynasties in order, what each one left behind, and where to see it on the ground today.
standfirst: Four thousand years is a lot to absorb. This is the version organised around what you will actually stand in front of.
eyebrow: History
order: 4
updated: 2026-08-01
keywords: [chinese history timeline, chinese dynasties, history of china for tourists, tang dynasty, ming dynasty]
facts:
  - First unified empire | Qin, 221 BCE
  - Golden age | Tang, 618–907
  - Great Wall you see | Ming, 1368–1644
  - Last emperor abdicated | 1912
  - PRC founded | 1949
related:
  - /destinations/xian/
...
China's history is usually told as a sequence of dynasties, each conventionally understood to have risen, consolidated, declined and been replaced — a framework Chinese historians themselves formalised as the "Mandate of Heaven". It is a simplification, but it is the one every museum label uses, so it is worth having.

| Period | Dates | What it left | Where to see it |
| --- | --- | --- | --- |
...
Ying Zheng conquered the six rival states and declared himself **Qin Shi Huang**, First Emperor. In fifteen years his administration standardised the script, the currency, the axle width of carts and the legal code, and connected existing frontier walls into an early Great Wall. He also built himself a tomb complex guarded by 8,000 terracotta soldiers, which is the single most spectacular archaeological site in China.

The dynasty collapsed four years after his death. The template of a centralised bureaucratic empire lasted two thousand years.
...
Kublai Khan completed the conquest and ruled China from **Dadu**, on the site of modern Beijing — which is why Beijing's street grid and its position as capital date from this period. Marco Polo's account, whatever its reliability, describes this China.

### Ming: what you photograph, 1368–1644

A Han restoration after Mongol rule, and the source of most of what a visitor sees. The **Forbidden City** (1420), the brick-faced **Great Wall** north of Beijing, the walls of **Xi'an**, **Pingyao** and **Nanjing**, and blue-and-white porcelain all date from the Ming. Zheng He's treasure fleets reached East Africa in the early 1400s before the court abandoned maritime expansion.

### Qing: the last dynasty, 1644–1912
...
- **Jonathan Spence, *The Search for Modern China*** — the standard single-volume history from the Ming onwards
- **John Keay, *China: A History*** — readable, single volume, the whole span
- **Peter Hessler, *River Town*** and ***Country Driving*** — the best writing on ordinary life in reform-era China
- **Julia Lovell, *The Opium War*** — how the 19th century still shapes Chinese foreign policy thinking
- **Journey to the West**, **Romance of the Three Kingdoms**, **Dream of the Red Chamber** — the classic novels whose characters appear in temples, operas and shop signs everywhere

## Frequently asked questions

### What are the Chinese dynasties in order?

The main sequence is Shang, Zhou, Qin, Han, Three Kingdoms and Six Dynasties, Sui, Tang, Song, Yuan, Ming, Qing, then the Republic from 1912 and the People's Republic from 1949. The Qin unified China in 221 BCE and the Qing was the last imperial dynasty.

### Which dynasty built the Great Wall?

Many did, but the brick-and-stone wall visitors see north of Beijing is Ming, built between the 14th and 17th centuries. Earlier walls, including the Qin-era connections of 221 BCE, were rammed earth and survive mostly as eroded ridges in the northwest.

### What was the Tang dynasty known for?

Its cosmopolitanism and its poetry. Between 618 and 907 the capital Chang'an — modern Xi'an — was the largest and most international city in the world, and Chinese poetry reached its acknowledged peak with Li Bai and Du Fu.
...
In February 1912, when the six-year-old Puyi abdicated and the Republic of China was declared, ending more than two thousand years of imperial rule that began with Qin Shi Huang in 221 BCE.
