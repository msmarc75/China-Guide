---
title: Herbal Medicine in China
navTitle: Herbal medicine
metaTitle: "Herbal Medicine in China: What Is in the Drawers"
description: The drawers behind a Chinese pharmacy counter hold a regulated product. A binding pharmacopoeia sets the standard, and the label must name the origin.
standfirst: The massage guide here names four branches of Chinese medicine and covers one. Three now have pages of their own. The fourth is the wall of small wooden drawers behind every Chinese pharmacy counter, and the Chinese medicine page describes it in a single sentence and moves on. What is in those drawers is not folklore sold loose. It is a product with a legally binding standard, a required label, and a rule about which province it may be sold in.
eyebrow: Culture
order: 26
updated: 2026-08-20
keywords: [chinese herbal medicine, chinese pharmacy drawers, chinese pharmacopoeia, buying chinese herbs, chinese medicine label]
facts:
  - The standard | The Pharmacopoeia, revised 2025
  - Part one | Chinese medicine, 3,069 entries
  - In force since | 1 October 2025
  - The label must give | Where the material was grown
  - Newest instrument | State Council Order 828
related:
  - /culture/chinese-medicine-in-china/
  - /food/food-as-medicine-in-china/
  - /culture/massage-and-bodywork-in-china/
---

The massage guide opens by naming [four branches of Chinese medicine — tuina, acupuncture, herbal medicine and dietary therapy](/culture/massage-and-bodywork-in-china/) — and then covers tuina, which is its subject. Since then [dietary therapy has got a page](/food/food-as-medicine-in-china/) and [acupuncture is set out with the institution that carries it](/culture/chinese-medicine-in-china/).
...
:::note Why the edition matters to a reader
A pharmacopoeia is rewritten every five years, and each rewrite changes what a figure means. A heavy-metal result quoted against the 2020 edition and one quoted against the 2025 edition are not the same claim, because the limit itself moved. If a seller shows you a test report, the useful question is which edition it was tested against.
:::
...
:::tip The three items worth looking for
**产地, the growing origin.** Chinese medicine attaches enormous commercial weight to where a material was grown, and the claim now has to be printed rather than asserted across a counter.

**保质期, a shelf life.** Dried material sold loose from a drawer has a stated expiry, which is not how most visitors imagine the trade works.

**执行标准, the standard it is made to.** This tells you whether the piece follows the national Pharmacopoeia or a provincial processing norm — the distinction the next section is about.

Separate labelling rules issued by the drug regulator as **announcement no. 90 of 2023**, in force from **1 August 2024** with the shelf-life requirement following on **1 August 2025**, add the details that make the label trustworthy: it must be **printed or stamped, never handwritten**, and it may not be **stuck over, cut or altered**. Any other language on it must be set no larger than the Chinese.
:::
...
1. **A producer must process its own pieces** and may not contract the processing out.
2. **Pieces made to a provincial norm may now be sold and used across provincial lines** — the default is open.
3. **Except for the confusable ones.** Where the processing method and usage characteristics differ regionally in a way liable to cause clinical confusion, a producer selling across provincial lines must **print clinical-use warning information on the label** and **file with the drug regulator of the receiving province**, while medical institutions must tighten procurement and monitoring.

That is the pattern this site has now met five times — the narrow risky case gated, everything else admitted on a lighter footing — and it is set out where the site first stated it as a general rule, in [the guide to high-risk sports](/guides/high-risk-sports-in-china/). Here the gate is itself only a filing, which is about as light as a gate gets.
...
- **Protected species end the conversation.** Any preparation containing a protected-species ingredient is illegal to bring home and frequently illegal to buy — [the customs categories sit with the shopping rules](/guides/shopping-in-china/), and the ingredient list is the thing to read. [The statute behind that sentence puts a traceability mark on the product](/food/caviar-and-sturgeon-in-china/), which gives you something to look for.
- **Your own medicines are a different question**, and the same 2026 regulation now states the personal-carriage principle expressly — [what you may bring in, and the narrower category that needs papers](/answers/can-i-bring-my-medication-to-china/).
