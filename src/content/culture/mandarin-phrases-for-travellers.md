---
title: Essential Mandarin for Travellers
navTitle: Mandarin basics
metaTitle: "Essential Mandarin Phrases for Travellers in China"
description: The Mandarin words and phrases that actually help in China — pronunciation basics, numbers, ordering food, transport, and how to survive with a translation app.
standfirst: You will not learn Chinese before your trip. You can learn twenty words that will change how people treat you, and understand enough about the writing system to use it.
eyebrow: Language
order: 2
updated: 2026-08-01
keywords: [mandarin phrases for travellers, basic chinese for tourists, chinese phrases travel, how to say hello in chinese, pinyin tones]
facts:
  - Tones | Four, plus a neutral
  - Most useful word | 这个 (zhè ge) — "this one"
  - Best app | Pleco (offline dictionary)
  - Written | Simplified characters on the mainland
  - Reality | English is rare outside hotels
related:
...
| --- | --- | --- | --- |
| First | ā | High and flat | mā 妈 mother |
| Second | á | Rising, like a question | má 麻 hemp |
| Third | ǎ | Dipping down then up | mǎ 马 horse |
| Fourth | à | Sharp falling, like a command | mà 骂 to scold |
| Neutral | a | Light and short | ma 吗 question particle |
...
| You're welcome / no problem | 不客气 | bú kè qi |
| Sorry / excuse me | 对不起 | duì bu qǐ |
| Excuse me (to get attention) | 请问 | qǐng wèn |
| Yes / correct | 对 | duì |
| No / not | 不是 | bú shì |
...
:::tip The single most useful word
**这个 (zhè ge)** — "this one". Point at a dish on someone else's table, a photo on a menu, an item in a display case, and say it. It works in every restaurant, market and shop in China, requires no tones to be right, and is exactly what Chinese people say themselves.
:::
...
| Beef / pork / chicken / fish | 牛肉/猪肉/鸡肉/鱼 | niú ròu / zhū ròu / jī ròu / yú |
| Rice | 米饭 | mǐ fàn |
| Noodles | 面条 | miàn tiáo |
| Beer | 啤酒 | pí jiǔ |
| Hot water | 热水 | rè shuǐ |
| Takeaway box | 打包 | dǎ bāo |

Note that **我吃素 (wǒ chī sù)** is understood as Buddhist vegetarianism and is the clearest way to say it — but dishes may still arrive with meat stock or oyster sauce. See [vegetarian and vegan travel in China](/food/vegetarian-vegan-in-china/).
...
| High-speed rail station | 高铁站 | gāo tiě zhàn |
| Metro | 地铁 | dì tiě |
| Bus | 公交车 | gōng jiāo chē |
| Ticket | 票 | piào |
| Please use the meter | 请打表 | qǐng dǎ biǎo |
| Stop here | 停这里 | tíng zhè lǐ |
| Take me to this address | 请带我去这个地址 | qǐng dài wǒ qù zhè ge dì zhǐ |
| Left / right / straight ahead | 左/右/直走 | zuǒ / yòu / zhí zǒu |
...
| --- | --- | --- |
| Help! | 救命！| jiù mìng |
| Call the police | 请叫警察 | qǐng jiào jǐng chá |
...
The apps below do different jobs, and [the case for installing two of them rather than one](/answers/what-is-the-best-app-for-translating-chinese/) is worth reading before you leave. They also cover the gap where [Mandarin is not the first language](/answers/is-mandarin-spoken-everywhere-in-china/) — written Chinese is identical nationwide even where the spoken language is not.
