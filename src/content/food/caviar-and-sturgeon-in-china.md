---
title: Caviar and Sturgeon in China
navTitle: Caviar and sturgeon
metaTitle: "Caviar and Sturgeon in China: The Mark and the Permit"
description: China farms sturgeon and exports caviar, while its own native sturgeon is protected. Both the tin and the export need paperwork that the law names exactly.
standfirst: Two pages here tell you that a protected-species ingredient ends the conversation, and neither says what the system behind that sentence is. Meanwhile the word caviar does not appear on this site at all, which is an odd blank for a country that farms sturgeon at scale. The two gaps have one answer, and it is a statute with a traceability mark in it.
eyebrow: Food
order: 19
updated: 2026-08-20
keywords: [caviar china, chinese sturgeon, buying caviar in china, china wildlife protection law, taking caviar home from china]
facts:
  - The native species | A first-class protected animal
  - The caviar | From farmed sturgeon, not wild
  - On the product | A traceability mark, by law
  - To export it | A permit from the CITES authority
  - The law | Revised 2022, in force May 2023
related:
  - /guides/shopping-in-china/
  - /culture/herbal-medicine-in-china/
  - /food/chinese-cuisine-regional-guide/
---

This site says twice that a protected-species ingredient ends the conversation — once about [Chinese medicinal materials](/culture/herbal-medicine-in-china/) and once about [health products bought to take home](/food/food-as-medicine-in-china/). Both are right. Neither explains what the system is, how a product gets inside it, or what you would be looking at if a product were compliant.
...
:::tip The mark is the twenty-fourth thing this site has found printed on the object itself
The statute does not say "keep records". It says obtain and use a mark, **保证可追溯** — guarantee traceability. The compliance lives on the product, where a buyer can see it.

That is the answer to the warning this site has been repeating without explanation. A lawful product in this category is one that carries its mark; an unmarked one is not a bargain, it is the problem.
:::
...
The two articles above I read in full, verbatim, on two independent official Chinese hosts, and the texts matched. **The convention's own caviar-labelling resolution I did not read from here**, so this page describes what that label is for and does not set out its code structure. The protection status of the Chinese sturgeon, the Yangtze fishing ban and the paddlefish extinction are widely reported and were not read on a government host this time — the agriculture ministry refused requests from here — so treat those three as reported rather than quoted, and the two articles as verified.
:::
