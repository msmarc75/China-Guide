---
title: Salmon in China
navTitle: Salmon
metaTitle: "Salmon in China: Which Fish, and Which Standard"
description: China farms salmon at altitude in Qinghai. An industry body redefined the word in 2018 to cover rainbow trout, and the packet label is where that shows up.
standfirst: Nineteen food pages here and the word salmon appears on none of them, which is odd for a country whose largest net-cage salmonid farms sit at 2,600 metres. It is odder still because the word itself was the subject of a public argument in China, settled by a document most people have never heard of — and the settlement is printed, in brackets, on the packet.
eyebrow: Food
order: 20
updated: 2026-08-20
keywords: [salmon in china, chinese salmon rainbow trout, 三文鱼 虹鳟, is chinese salmon safe raw, qinghai salmon farming]
facts:
  - Farmed in | Qinghai, in reservoir net cages
  - The species | Rainbow trout, not Atlantic salmon
  - The 2018 standard | A group standard, not a national one
  - What it requires | Species named on the label
  - Raw safety | Answered by GB 10136-2015
related:
  - /food/caviar-and-sturgeon-in-china/
  - /food/chinese-wine/
...
:::note One number, and why this page gives only one
Published shares for Qinghai's slice of national salmonid output range from about **30 per cent** to nearly **38 per cent** depending on which year the source is describing. Those are not competing claims about the same year; they are a rising trend reported at different dates. This page quotes the agriculture ministry's figure and its own framing, and leaves the rest alone rather than stacking numbers from different years as if they were one.
:::

That is a shape this site has met before with coffee, with wine and with [farmed sturgeon](/food/caviar-and-sturgeon-in-china/): a product nobody associates with China, produced there in quantity.
...
:::warn A trade association did not rename a fish for the whole country
Read the two articles together and the 2018 argument resolves itself. The association wrote a standard for its own members to adopt by agreement. It is the **fourth rung of five**, and nothing on that rung binds anybody who did not sign up to it.

State broadcast coverage put it in one line: 团体标准仅是"供社会自愿采用"，这也意味着，团体标准没有强制指导力和约束力 — a group standard is only *for voluntary adoption by society*, which means it carries **no compulsory force and no binding effect**.

So the honest answer to "is rainbow trout officially salmon in China" is: **an industry body says so, for its members, voluntarily.** That is a real fact about the market and not a fact about the law.
:::
