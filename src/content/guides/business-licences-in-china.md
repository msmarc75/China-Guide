---
title: The Business Licence on the Wall in China
navTitle: Business licences
metaTitle: "Chinese Business Licences: The Code on the Wall"
description: Every Chinese business from a noodle stall upwards must display one document, and the unified code printed on it is how you check that a shop is real.
standfirst: This site calls something "licensed" on thirty-five pages — a licensed agency, a licensed hotel, a licensed driver, a licensed refund store — and has never once said what a licence looks like, where it has to hang, or how you would tell. There is a single document underneath all of it, and it is on the wall of every business in the country.
eyebrow: Practicalities
order: 49
updated: 2026-08-20
keywords: [china business licence, unified social credit code, is this chinese shop legitimate, china company registration check, 营业执照]
facts:
  - Who needs one | Every business, down to a stall
  - Where | A conspicuous position at the premises
  - On the face | A code, the scope, the registrar
  - Also required | Online sellers show it on the home page
  - Never lawful | Renting, lending or transferring it
related:
  - /guides/hygiene-licences-in-china/
  - /guides/marked-prices-in-china/
  - /guides/tour-guides-in-china/
---
...
There is an object. The hygiene page already unpacked [the third document on a Chinese wall](/guides/hygiene-licences-in-china/); this is the fourth, and it is the one that comes before all the others.
...
That is the identical move the site met in a delivery app, where [a caterer must keep its credentials and its real address on its listing](/guides/food-delivery-in-china/). The wall and the home page are the same requirement, applied to whichever surface the customer actually looks at.
...
It is also the sharp end of the distinction the terracotta warriors page draws, where [a licensed agency running an unlawful shopping stop owes you a refund while a seller on the forecourt has no licence to lose](/answers/how-do-i-get-to-the-terracotta-army-from-xian/). The licence is what makes a counterparty findable afterwards.
...
:::warn What this is actually worth on a two-week trip
The publicity system is a Chinese-language service with a verification step, and it is not a realistic tool for a visitor standing in a shop doorway. Treat it as something a Chinese-speaking friend, a hotel concierge or a colleague can check for you when a sum of money justifies it — not as a habit.

What the licence itself gives you on the spot is smaller and genuinely useful: **it is there or it is not**, the business scope tells you what the place claims to be, and the code turns a vague complaint into an identified business.
:::
...
- **The licence is the floor, not the ceiling.** Whatever the trade needs on top of it, [that is a different document](/guides/hygiene-licences-in-china/), and the difference is the whole point.
- **A price dispute is separate again** — [the marked-price rules govern the gap between the sign and the bill](/guides/marked-prices-in-china/), whoever holds the licence.
...
### Is it legal to borrow or rent a business licence in China?
