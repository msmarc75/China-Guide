---
title: Express Delivery in China
navTitle: Express delivery
metaTitle: "Express Delivery in China: The Rules on Parcels"
description: You cannot post a parcel anonymously in China: the counter checks your ID and opens the box. And a courier may not leave it in a locker without asking.
standfirst: China moved 175 billion parcels in 2024 and this site keeps brushing against the system that carried them — a clause about undeliverable parcels quoted on one page, a customs declaration described on another, a hotel desk taking your delivery on a third. The regime itself has never been set out. It is regulated tightly at both ends, in ways a visitor does not expect: you cannot hand a parcel over anonymously or unopened, and nobody may leave one for you in a locker without asking.
eyebrow: Practicalities
order: 61
updated: 2026-08-20
keywords: [china express delivery, 快递暂行条例, real name posting china, china parcel locker rules, send parcel within china]
facts:
  - Volume | 175 billion parcels in 2024
  - At the counter | Identity checked, contents inspected
  - Refuse either | The company may not accept it
  - Locker delivery | Requires your consent
  - Amended | 1 June 2025, new packaging chapter
related:
  - /guides/sending-things-home-from-china/
  - /culture/blind-boxes-in-china/
  - /guides/food-delivery-in-china/
---

Parcels turn up on this site in passing and never as a subject. [The blind box page](/culture/blind-boxes-in-china/) quotes a rule barring the sale of express items that can be neither delivered nor returned. [The shipping guide](/guides/sending-things-home-from-china/) tells you to fill in a customs declaration accurately. [The food delivery guide](/guides/food-delivery-in-china/) notes that a hotel desk usually takes the handover.
...
:::warn You cannot post anonymously, and you cannot post a sealed box
Two separate obligations bite at the counter, and both are drafted as a prohibition on the *company* rather than on you.

**Identity.** Article 26(3) of the 2023 Measures:

> 依法对寄件人身份进行查验，登记身份信息，寄件人拒绝提供身份信息或者提供身份信息不实的，不得收寄

The company must **verify the sender's identity and register the identity information**, and where the sender refuses to provide it, or provides false information, **it must not accept the item**.

**Contents.** Article 32 of the regulation:

> 经营快递业务的企业收寄快件，应当依照《中华人民共和国邮政法》的规定验视内件，并作出验视标识。寄件人拒绝验视的，经营快递业务的企业不得收寄。

The company must **inspect the contents** and **make an inspection mark**. If the sender refuses inspection, it **must not accept** the item. Article 26(4) of the Measures adds the other half: the company registers the item name, and if the declared contents **do not match what the inspection found**, again it must not accept.

So a Chinese parcel is handed over open, item by item, to someone who writes down what is in it and who you are. That is 实名收寄 (*shímíng shōujì*, real-name posting) and 收寄验视 (*shōujì yànshì*, inspection on acceptance), and Article 32 of the Measures names them as standing systems the company must operate.
:::
...
:::warn A locker is not a delivery unless you agreed to it
This one exists in two instruments, and the second widened the first.

The **智能快件箱寄递服务管理办法** (Measures for the Administration of Smart Parcel Locker Delivery Services), **Ministry of Transport Order No. 16 of 2019**, in force from 1 October 2019, put it first, at Article 22:

> 智能快件箱使用企业使用智能快件箱投递快件，应当征得收件人同意；收件人不同意使用智能快件箱投递快件的，智能快件箱使用企业应当按照快递服务合同约定的名址提供投递服务。寄件人交寄物品时指定智能快件箱作为投递地址的除外。

Consent is required; without it, delivery goes to the name and address in the contract. **Except** — and the exception is easy to miss — where **the sender** nominated the locker as the delivery address in the first place.

Article 25 of the same Measures adds that the operator must set a reasonable storage period and **may not charge the recipient within it**.

The 2023 Measures then widened the rule from lockers to the whole last mile. Article 28, third paragraph:

> 经营快递业务的企业未经用户同意，不得代为确认收到快件，不得擅自将快件投递到智能快件箱、快递服务站等快递末端服务设施。

Without the user's consent, a company may not **confirm receipt on their behalf**, and may not put the parcel into **a smart locker, a delivery service point or any other last-mile facility**.

It is enforced as an administrative matter. Article 54 of the Measures makes three things finable — confirming receipt without consent, using a locker or service point without consent, and, in its own words, **抛扔快件、踩踏快件的**: throwing parcels, or standing on them. A warning or public criticism, with a fine of up to 10,000 yuan, or 10,000 to 30,000 yuan in serious cases.
:::

## Delay, loss and damage: the split that decides what you get

:::money Two regimes, and you choose which one you are in at the counter
Article 28 of the regulation is short and it forks:

> 快件延误、丢失、损毁或者内件短少的，对保价的快件，应当按照经营快递业务的企业与寄件人约定的保价规则确定赔偿责任；对未保价的快件，依照民事法律的有关规定确定赔偿责任。

Where a parcel is **delayed, lost, damaged or short of its contents**, an item that was **declared for value** (保价, *bǎojià*) is compensated **according to the declared-value rules agreed between the company and the sender**. An item that was **not** declared falls to be compensated **under the general civil law**.

That is not a difference of amount so much as a difference of instrument: one is a contract term you accepted, the other is a claim you argue. Article 26(2) of the 2023 Measures requires the company, **before the sender provides the waybill information**, to remind them to read the contract terms and observe the prohibited-items rules, and to inform them of the applicable declared-value rules and insurance services. The choice is therefore put to you at the counter rather than discovered afterwards.

The regulation ends the article by encouraging insurers to develop parcel-loss products and companies to buy them, which is drafted as 鼓励 (*gǔlì*) — encouragement, not obligation.
:::
...
That is the pipeline behind [the rule that undeliverable express parcels may not be sold as blind boxes](/culture/blind-boxes-in-china/): the regulation already says where they go, and it is not into a mystery box.
...
- **Posting is not a route around an export restriction.** Items barred from leaving the country are one of the nineteen prohibited categories — [the antiques and wildlife rules are the ones that catch visitors](/guides/shopping-in-china/).
...
- **Hong Kong and Macau are outside all of this.** Both are separate customs territories with their own legal systems, so none of the instruments above governs a parcel sent within or from either — [which is the same architecture that puts them outside every other national rule on this site](/destinations/macau/).
