---
title: Sold a Fake in China
navTitle: Sold a fake
metaTitle: "Sold a Fake in China: Refund Plus Three Times the Price"
description: This site warns about fakes on a dozen pages and never says what you are owed. Chinese law gives a defrauded buyer the price back plus three times more.
standfirst: The advice here on fakes is uniformly defensive — avoid jade, avoid the tour stop, avoid the pearls, check the silk with a burn test. All of it is sound, and all of it assumes that being deceived is a loss you absorb. Chinese law takes a much harder line than that, and it has a number attached.
eyebrow: Shopping
order: 50
updated: 2026-08-20
keywords: [sold a fake in china, china consumer rights refund, china three times compensation, 退一赔三, china counterfeit goods refund]
facts:
  - The general rule | Refund, plus three times the price
  - The floor | Never less than 500 yuan
  - For food | Ten times the price, floor 1,000
  - The test | Deliberate deception that changed your mind
  - Realistic route | 12315, not a courtroom
related:
...
:::warn A mismatch is not automatically fraud
A description that does not match the object is not, by itself, enough. What matters is whether the untrue point was **material to the decision to buy** — a key factor rather than a detail.

So "the label said 100% silk and it is a blend" is squarely inside the rule, because that is the thing you were buying. "The box says the pot holds 200 ml and it holds 190" is the kind of discrepancy the rule is not built for. Between those poles sits a judgement, and it is the seller who has to have been deliberate about it.
:::

This matters for the classic tourist purchases. **What a stone actually is can be settled by a laboratory** — [the jade certificate has to state whether the material is natural, treated, assembled, synthetic or imitation](/guides/buying-jade-in-china/) — so a stone sold as natural and certified as treated is a documented mismatch on the central point. **What you were charged is a different question entirely**, and one the law does not touch.
...
The same honesty this site applies to [the seven-day right on a prepaid card](/guides/prepaid-cards-in-china/) applies here.
...
- **A route that is not a court.** **12315**, the market regulator's line, is [the same number behind overcharging complaints](/guides/marked-prices-in-china/), and it handles misdescription too.
...
- **Avoidance is still the better plan**, which is why [the shopping guide's cautions stand unchanged](/guides/shopping-in-china/). A remedy is a repair.
