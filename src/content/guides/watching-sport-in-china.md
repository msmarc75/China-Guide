---
title: Watching Sport in China
navTitle: Watching sport
metaTitle: "Watching Sport in China: Tickets, Leagues and Village Games"
description: Tickets to any event over 5,000 people are tied to your passport and checked at the gate. What is worth watching, and when each season runs.
standfirst: A stadium is one of the cheapest and least touristed evenings available to a visitor in China, and the most interesting football in the country right now is amateur. The obstacle is the same one as everywhere else — the ticket is attached to your passport.
eyebrow: Attractions
order: 15
updated: 2026-08-20
keywords: [watching football in china, chinese super league tickets, cba basketball tickets, su chao jiangsu league, village super league guizhou]
facts:
  - Ticketing | Real-name for any event over 5,000 people
  - One passport | Generally one ticket
  - Football (CSL) | Broadly March to November
  - Basketball (CBA) | Winter; the calendar recently moved
  - The phenomenon | Amateur leagues outdrawing professional ones
related:
...
What makes it good to attend is precisely what makes it amateur: the rivalries are between cities that have needled each other for centuries, the crowd is entirely local, and the football is beside the point. [Nanjing](/destinations/nanjing-qingdao/) is the most accessible place to catch it for a visitor already on the standard route.
