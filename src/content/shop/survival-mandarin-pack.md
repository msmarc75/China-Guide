---
title: The Offline Survival Mandarin Pack
navTitle: Survival Mandarin Pack ($9)
metaTitle: "Offline Survival Mandarin Pack: 120 Phrase Cards for China"
description: 120 screenshot-ready Mandarin phrase cards with characters, pinyin and audio — built to be shown to a taxi driver when your data has died.
standfirst: Translation apps fail when the battery dies or the signal drops. Screenshots do not.
eyebrow: Resource
order: 2
updated: 2026-08-01
noindex: true
...
facts:
  ...
  - Cards | 120
  - Works offline | Yes, entirely
  - Price | $9
related:
  - /shop/china-trip-planner/
  - /culture/mandarin-phrases-for-travellers/
  - /food/how-to-order-food-in-china/
---

:::warn Not yet on sale
This product page is a template. The payment integration is not connected — see the monetisation notes in the project repository for how to wire it to a payment processor and file delivery.
:::
...
| Category | Cards |
| --- | --- |
| Greetings and basic courtesy | 10 |
| Taxis, directions and transport | 20 |
| Hotels and check-in | 12 |
| Ordering food, including dietary restrictions | 30 |
| Shopping and bargaining | 12 |
| Numbers, prices and time | 10 |
| Medical and emergency | 15 |
| Trains, stations and airports | 11 |
